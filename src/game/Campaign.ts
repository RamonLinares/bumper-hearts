...
export type CollectibleKind =
  | 'ticket' | 'bulb' | 'radio-coil' | 'cafe-token' | 'trophy-star'
  | 'fuse' | 'storm-lantern' | 'evidence-card' | 'love-letter' | 'marquee-heart';

export type StageVisualTheme = {
  accent: string;
  floorTint: string;
  fog: string;
  floorPattern: 'ticket-grid' | 'circuit' | 'radio-waves' | 'cafe-checker' | 'champion-sunburst' | 'midnight-grid' | 'storm-coils' | 'case-files' | 'sunset-ribbons' | 'marquee-rays';
  secondary: string;
  lightColor: string;
  dressing: 'ticket-night' | 'neon-lab' | 'radio-club' | 'cafe-date' | 'sponsors-cup' | 'after-hours' | 'blackout' | 'school-fair' | 'sunset' | 'grand-finale';
};

export type StageCollectibles = {
...
export type CampaignStage = {
  ...
  collectibles: StageCollectibles;
  intro: StoryBeat;
  outro: StoryBeat;
};
...
export const CAMPAIGN_STAGES: readonly CampaignStage[] = [
  {
    ...
    theme: { accent: '#f5c45b', floorTint: '#fff2d0', fog: '#25314a', floorPattern: 'ticket-grid', secondary: '#d54a5b', lightColor: '#ffd998', dressing: 'ticket-night' },
    collectibles: { kind: 'ticket', name: 'Ride tickets', color: '#f5c45b', positions: [[-8,-4],[-4,-5],[1,-4.3],[7,-4],[-7,3],[-2,4.8],[3.5,3.8],[8,1.5]] },
  ...
  },
  {
    ...
    theme: { accent: '#62b8d2', floorTint: '#e4f6f4', fog: '#203b52', floorPattern: 'circuit', secondary: '#ff6e91', lightColor: '#9af7e8', dressing: 'neon-lab' },
    collectibles: { kind: 'bulb', name: 'Circuit bulbs', color: '#71e3d1', positions: [[-8,0],[-5,-3],[-2,-5],[2,-3],[6,-5],[8,-1],[5,3],[0,4.8]] },
  ...
  },
  {
    ...
    theme: { accent: '#9b83c6', floorTint: '#eee8fa', fog: '#332b50', floorPattern: 'radio-waves', secondary: '#65d4ca', lightColor: '#c8b6ff', dressing: 'radio-club' },
    collectibles: { kind: 'radio-coil', name: 'Radio coils', color: '#9b83c6', positions: [[0,-5.5],[-4,-4],[-7,-1],[-5,3],[0,5],[5,3],[7,-1],[4,-4]] },
  ...
  },
  {
    ...
    theme: { accent: '#e7ad43', floorTint: '#fff0c9', fog: '#4a3928', floorPattern: 'champion-sunburst', secondary: '#7d2c38', lightColor: '#fff0a8', dressing: 'sponsors-cup' },
    collectibles: { kind: 'trophy-star', name: 'Sponsor stars', color: '#f0b63e', positions: [[-8,-4],[-5,-1],[-8,3],[-2,4.8],[2,2],[7,4],[8,0],[4,-4.5]] },
  ...
  },
  {
    ...
    theme: { accent: '#58b8b1', floorTint: '#dff4ee', fog: '#173d46', floorPattern: 'midnight-grid', secondary: '#e65e72', lightColor: '#7ff7dd', dressing: 'after-hours' },
    collectibles: { kind: 'fuse', name: 'Replacement fuses', color: '#58d4c5', positions: [[-8,4],[-8,0],[-8,-4],[-3,-2],[0,4.7],[3,2],[8,4],[8,-3]] },
  ...
  },
  {
    ...
    theme: { accent: '#83b7e8', floorTint: '#dce8f5', fog: '#14253d', floorPattern: 'storm-coils', secondary: '#f4d35e', lightColor: '#b5d9ff', dressing: 'blackout' },
    collectibles: { kind: 'storm-lantern', name: 'Emergency lanterns', color: '#ffd35a', positions: [[-7,-4],[-2,-5],[3,-4.5],[7,-2],[8,3],[3,4],[-2,2],[-7,4]] },
  ...
  },
  {
    ...
    theme: { accent: '#d95e68', floorTint: '#f8e1e5', fog: '#4a2734', floorPattern: 'case-files', secondary: '#284d72', lightColor: '#ffb6c2', dressing: 'school-fair' },
    collectibles: { kind: 'evidence-card', name: 'Evidence cards', color: '#f4e5b5', positions: [[-8,-3],[-4,-1],[-7,4],[-1,4.5],[2,1],[7,4],[5,-1],[8,-4]] },
  ...
  },
  {
    ...
    theme: { accent: '#ef8a6b', floorTint: '#ffe2d1', fog: '#553246', floorPattern: 'sunset-ribbons', secondary: '#795087', lightColor: '#ffc394', dressing: 'sunset' },
    collectibles: { kind: 'love-letter', name: 'Unsent letters', color: '#fff0dc', positions: [[-8,-4],[-5,1],[-8,4],[-2,3],[0,-2],[3,-4],[6,0],[8,4]] },
  ...
  },
  {
    ...
    theme: { accent: '#f5c45b', floorTint: '#fff0c2', fog: '#372a46', floorPattern: 'marquee-rays', secondary: '#d84058', lightColor: '#fff1a8', dressing: 'grand-finale' },
    collectibles: { kind: 'marquee-heart', name: 'Marquee hearts', color: '#f05264', positions: [[0,-5.5],[-6,-4],[-8,0],[-6,4],[0,5],[6,4],[8,0],[6,-4]] },
